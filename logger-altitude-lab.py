...
def dashboard(screen):
    ...
    while True:
        ...
        if len_local_last_altitude_frame > 0:
            ...
            screen.print_at(f'PITCH:{math.degrees(altitude.pitch/10000):05.2f} '
                            f'ROLL:{math.degrees(altitude.roll/10000):05.2f} '
                            f'YAW:{math.degrees(altitude.yaw/10000):05.2f} '
